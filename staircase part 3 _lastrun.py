...
expName = 'staircase part 3 '  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/annie/Library/Mobile Documents/com~apple~CloudDocs/staircase/staircase part 3 _lastrun.py',
